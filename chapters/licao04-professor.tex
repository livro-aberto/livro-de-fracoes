...
igualmente válidos e indistinguíveis.
  ...
  As sistematizações dos procedimentos de   {\bfseries comparação}   (atividades \ref{chap4-ativ12}  ,
...
keepaspectratio]{licao04/ativ2_fig01.png} & 10 & 3 &  
$\dfrac{3}{10}$ \tabularnewline
      \hline
       \includegraphics[width=110pt,
keepaspectratio]{licao04/ativ2_fig02.png} &  20 & 6 & 
$\dfrac{6}{20}$ \tabularnewline
      \hline
       \includegraphics[width=110pt,
keepaspectratio]{licao04/ativ2_fig03.png} &  30 & 9 & 
$\dfrac{9}{30}$ \tabularnewline
      \hline
       \includegraphics[width=110pt,
keepaspectratio]{licao04/ativ2_fig04.png} &  40 & 12 & 
$\dfrac{12}{40}$ \tabularnewline
      \hline
      \includegraphics[width=110pt, keepaspectratio]{licao04/ativ2_fig05.png}&  60 & 18 &   $\dfrac{18}{60}$ \tabularnewline
      \hline
      \includegraphics[width=110pt, keepaspectratio]{licao04/ativ2_fig06.png}&  80 & 24 &  $\dfrac{24}{80}$ \tabularnewline
      \hline
    \end{tabular}
\begin{multicols}{2}
\end{atividade}
...
\begin{tabular}{|e{0.10\textwidth}|e{0.08\textwidth}|e{0.08\textwidth}
|e{0.08\textwidth}|}
    \hline
...
livro.
\item 	A parte 1 desta atividade foi desenvolvida na \hyperref[chap3-ativ17]{Atividade 17 da Lição 3}. Avalie a necessidade de realizá-la novamente.
    \item       É importante, ao final da atividade, observar para os alunos que
...
\begin{center}
  \begin{tabular}{|e{.4\textwidth}|e{.2\textwidth}|e{.2\textwidth}|}
    \hline
...
\paragraph{PARTE 2}
\begin{center}
\begin{tabular}{|e{.3\textwidth}|e{.15\textwidth}|e{.15\textwidth}|e{
.15\textwidth}|}
 \hline
...
fração do retângulo do encarte?  &  Fração do encarte não colorida de cinza? \\
 ...
 \fit{\begin{tikzpicture}[x=1mm, y=1mm]
  ...
  \end{tikzpicture}} &  \fit{$1$} &  \fit{$\dfrac{1}{2}$} &
\fit{$\frac{1}{2}$} \\
    \hline
\centering  \fit{\begin{tikzpicture}[x=1mm, y=1mm]
...
\item $\dfrac{4}{3} = \dfrac{8}{6} = \dfrac{12}{9} = \dfrac{16}{12}$.

\item Ao se subdividir cada terço em cinco partes iguais, obtém-se segmentos que são $\dfrac{1}{15}$ da unidade. 
Portanto, $\dfrac{4}{3} = \dfrac{20}{15}$.
...
\begin{center}
\includegraphics[width=.2\linewidth]{licao04/ativ11_fig01-solucao}
\end{center}
