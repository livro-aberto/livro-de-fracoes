...
\begin{center}
\begin{tabular}{ccc}
\includegraphics[width=100pt, keepaspectratio]{licao05/ativ1_fig01.png} &\quad \quad&\includegraphics[width=100pt, keepaspectratio]{licao05/ativ1_fig02.png}\\ \\
...
\includegraphics[width=.5\linewidth]{licao05/ativ2_fig01}
\end{figure}
...
\begin{center}
\begin{tikzpicture}[x=1.0cm,y=1.0cm, scale=.5]
\draw[fill=redribbon] (0.,1) rectangle (12.,3.);
\foreach \x in {4,8} \draw[dashed] (\x,1) -- (\x,3);
\draw[fill=blueribbon] (0.,-2) rectangle (12.,0.);
\draw[dashed] (6,-2) -- (6,0);
\draw[fill=yellowribbon] (0.,-5) rectangle (12.,-3.);
...
\begin{center}
\begin{tikzpicture}[x=1.0cm,y=1.0cm, scale=.5]
\draw[fill=yellowribbon] (0.,0) rectangle (3,2);
\draw[fill=blueribbon] (3,0) rectangle (9.,2.);
\draw[fill=yellowribbon] (9,0) rectangle (12,2);
\end{tikzpicture}
\end{center}

Ela verificou que a nova fita formada tinha o mesmo tamanho da fita original. Isso aconteceu porque cada pedaço azul tem o mesmo tamanho de dois pedaços amarelos. Podemos representar o tamanho da nova fita formada pela professora por meio de uma {\bfseries soma de frações}. Cada pedaço azul corresponde a $\frac{1}{2}$ da fita original. Cada pedaço amarelo corresponde a $\frac{1}{4}$ da fita original, então 2 pedaços amarelos correspondem a $\frac{2}{4}$ da fita original. Portanto, o tamanho da nova fita é igual a: $$\dfrac{1}{2} + \dfrac{2}{4}.$$ Mas, como $\frac{2}{4}$ é igual a $\frac{1}{2}$ (cada pedaço azul tem o mesmo tamanho de dois pedaços amarelos), então: $$\dfrac{1}{2} + \dfrac{2}{4} = \dfrac{1}{2} + \dfrac{1}{2}.$$ O resultado dessa soma $\frac{1}{2} + \frac{1}{2}$ é igual 2 pedaços de $\frac{1}{2}$, isto é, $\frac{2}{2}$ (que é igual 1). Assim: $$\dfrac{1}{2} + \dfrac{2}{4} = \dfrac{1}{2} + \dfrac{1}{2} = 1.$$ Neste caso, o resultado 1 corresponde ao tamanho da fita original.
 \begin{enumerate}\setcounter{enumi}{1}  %s
 \item A professora também agrupou pedaços de fita, juntando 1 pedaço amarelo e 1 pedaço azul, como na figura a seguir. A qual fração do tamanho original das fitas esses dois pedaços juntos correspondem?
\end{enumerate} %s

%\begin{center}
%\includegraphics[width=330pt, keepaspectratio]{licao05/ativ2_fig01.png}
%\end{center}
...
Uma barra de chocolate é vendida com as marcações mostradas na figura abaixo.
 ...
 \begin{center}
 \includegraphics[width=150pt, keepaspectratio]{licao05/ativ3_fig01.png}
 \end{center}
...
Amanda, Bruno e Caio pediram três pizzas do mesmo tamanho, mas com sabores diferentes. Todas as pizzas nessa pizzaria são servidas em {\bfseries 12 fatias} iguais. Amanda comeu $\frac{1}{6}$ de uma pizza, Bruno comeu $\frac{3}{4}$ de outra, e Caio comeu $\frac{2}{3}$ da pizza que pediu.

\begin{center}
\begin{tabular}{m{.3\textwidth}m{.3\textwidth}m{.3\textwidth}}

\begin{tikzpicture}[scale=.7]
\fill[cbyellow, opacity = .8] (0,0) -- (30:20) arc (30:90:20) --cycle;
...
\foreach \x in {0,90}{ \draw[very thick] (\x:20) -- (\x:-20);}
\draw[|-|] (0:25) arc (0:90:25);
\node[xshift=.5cm, overlay] at (45:30) {$\dfrac{1}{4}$};
\draw (0,0) circle (20);
\end{tikzpicture}
\quad\quad\quad\quad
\begin{tikzpicture}[scale=.5]
...
\foreach \x in {-30,90,210}{ \draw[very thick] (0,0) -- (\x:20);}
\draw[|-|] (-30:25) arc (-30:90:25);
\node[xshift=.5cm, overlay] at (30:30) {$\dfrac{1}{3}$};
\draw (0,0) circle (20);
\end{tikzpicture}
\end{center}
...
\begin{center}
	...
	\foreach \x in {30,90,150}{ \draw[very thick] (\x:20) -- (\x:-20);}
	\draw[|-|,overlay] (30:25) arc (30:90:25);
	\node at (90:30) {\phantom{a}};
	\node[xshift=.5cm, overlay] at (58:32) {$\dfrac{1}{6}$};
	\draw (0,0) circle (20);
	\end{tikzpicture}
		\quad\quad\quad\quad
	\begin{tikzpicture}[scale=.5]
	\fill[common, opacity = .8] (0,0) -- (-180:20) arc (-180:90:20) --cycle;
	\foreach \x in {0,90}{ \draw[very thick] (\x:20) -- (\x:-20);}
	\draw[|-|,overlay] (90:25) arc (90:-180:25);
	\node[xshift=.5cm, overlay] at (45:30) {$\dfrac{3}{4}$};
	\draw (0,0) circle (20);
	\end{tikzpicture}
		\quad\quad\quad\quad
	\begin{tikzpicture}[scale=.5]
	...
	\foreach \x in {0,90}{ \draw[very thick] (\x:20) -- (\x:-20);}
	\draw[|-|,overlay] (90:25) arc (90:-180:25);
\draw[|-|,overlay] (120:25) arc (120:180:25);
	\node[xshift=.6cm, overlay] at (35:38) {$\dfrac{1}{6} + \dfrac{3}{4} = ?$};
	\draw (0,0) circle (20);
...
\begin{center}
	...
	\draw[|-|,overlay] (30:25) arc (30:90:25);
	\node at (90:30) {\phantom{a}};
	\node[xshift=.5cm, overlay] at (52:36) {$\dfrac{1}{6} = \dfrac{2}{12}$};
	\draw (0,0) circle (20);
	...
	\foreach \x in {0,90}{ \draw[very thick] (\x:20) -- (\x:-20);}
	\draw[|-|,overlay] (90:25) arc (90:-180:25);
	\node[xshift=.5cm, overlay] at (52:36) {$\dfrac{3}{4}=\dfrac{9}{12}$};
	\draw (0,0) circle (20);
		\foreach \x in {0,30,...,330} \draw (0,0) -- (\x:20);
	\end{tikzpicture}
	\quad\quad\quad\quad
	...
	\draw[|-|,overlay] (90:25) arc (90:-180:25);
	\draw[|-|,overlay] (120:25) arc (120:180:25);
	\node[xshift=1.25cm, overlay] at (52:36) {$\dfrac{2}{12} + \dfrac{9}{12} = \dfrac{11}{12}$};
	\draw (0,0) circle (20);
	\draw [very thick] (0,0) -- (120:20);
	\foreach \x in {0,30,...,330} \draw (0,0) -- (\x:20);
	\end{tikzpicture}
...
\begin{center}
	...
	\foreach \x in {30,90,150}{ \draw[very thick] (\x:20) -- (\x:-20);}
	\draw[|-|,overlay] (30:25) arc (30:90:25);
	\node[xshift=.5cm, overlay] at (52:36) {$\dfrac{1}{6} = \dfrac{4}{24}$};
	\node at (90:30) {\phantom{a}};
	\draw (0,0) circle (20);
	...
	\foreach \x in {0,90}{ \draw[very thick] (\x:20) -- (\x:-20);}
	\draw[|-|,overlay] (90:25) arc (90:-180:25);
	\node[xshift=.5cm, overlay] at (52:36) {$\dfrac{3}{4}=\dfrac{18}{24}$};
	\draw (0,0) circle (20);
	\foreach \x in {0,30,...,330} \draw  (0,0) -- (\x:20);
    \foreach \x in {0,15,...,345} \draw [very thin] (0,0) -- (\x:20);
	...
	\draw[|-|,overlay] (90:25) arc (90:-180:25);
	\draw[|-|,overlay] (120:25) arc (120:180:25);
	\node[xshift=1.25cm, overlay] at (52:36) {$\dfrac{4}{24} + \dfrac{18}{24} = \dfrac{22}{24}$};
	\draw (0,0) circle (20);
	\draw [very thick] (0,0) -- (120:20);
	\foreach \x in {0,30,...,330} \draw  (0,0) -- (\x:20);
    \foreach \x in {0,15,...,345} \draw [very thin] (0,0) -- (\x:20);
...
\begin{center}
	...
	\foreach \x in {30,90,150}{ \draw[very thick] (\x:20) -- (\x:-20);}
	\draw[|-|,overlay] (30:25) arc (30:90:25);
	\node[xshift=.5cm, overlay] at (52:36) {$\dfrac{1}{6} = \dfrac{6}{36}$};
	\node at (90:30) {\phantom{a}};
	\draw (0,0) circle (20);
	\foreach \x in {30,60,...,330} \draw  (0,0) -- (\x:20);
	...
	\foreach \x in {0,90}{ \draw[very thick] (\x:20) -- (\x:-20);}
	\draw[|-|,overlay] (90:25) arc (90:-180:25);
	\node[xshift=.5cm, overlay] at (52:36) {$\dfrac{3}{4}=\dfrac{27}{36}$};
	\draw (0,0) circle (20);
	\foreach \x in {0,30,...,330} \draw  (0,0) -- (\x:20);
	\foreach \x in {0,10,...,350} \draw [very thin] (0,0) -- (\x:20);
	...
	\draw[|-|,overlay] (90:25) arc (90:-180:25);
	\draw[|-|,overlay] (120:25) arc (120:180:25);
	\node[xshift=1.25cm, overlay] at (52:36) {$\dfrac{6}{36} + \dfrac{27}{36} = \dfrac{33}{36}$};
	\draw (0,0) circle (20);
	\draw [very thick] (0,0) -- (120:20);
	\foreach \x in {0,30,...,330} \draw  (0,0) -- (\x:20);
	\foreach \x in {0,10,...,350} \draw [very thin] (0,0) -- (\x:20);
...
\node at (105pt, 2+1/6) {1 fração de $\dfrac{1}{3}$};
\node at (105pt, 1.6) {$+$};
\node at (105pt, 1) {6 frações de $\dfrac{1}{3}$};
...
Observando a reta, Miguel conseguiu determinar o tamanho do segmento destacado entre os dois pontos $A = 3$ e $B = 7$ marcados da seguinte forma:
...
\draw[common, line width=0.6mm] (3,0) -- (7,0);
\foreach \x in {3,7} \fill[common] (\x,0) circle (3 pt);
\node[above] at (3,3pt) {$A$};
\node[above] at (7,3pt) {$B$};
\node at (5,-30pt) {{\Large \textcolor{attention}{7}$-$\textcolor{cbolive}{3}$=$\textcolor{common}{4}}};
\draw[|-|, shift={(0,-30pt)},  color=cbgreen, line width=0.4mm] (0,0)--(3,0);
...
\includegraphics[width=.5\linewidth]{licao05/ativ13-fig01}
\end{figure}
\end{atividade}
...
\begin{center}
  \includegraphics[width=90pt, keepaspectratio]{licao05/ativ14_fig01.png}\hspace{1cm}
    \includegraphics[width=90pt, keepaspectratio]{licao05/ativ14_fig02.png}\hspace{1cm}
      \includegraphics[width=90pt, keepaspectratio]{licao05/ativ14_fig03.png}
\end{center}
