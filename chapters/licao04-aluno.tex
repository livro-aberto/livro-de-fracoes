...
% \node [anchor=center] at (0,0) {\includegraphics[width=.98\linewidth]{licao04/quadrinho-introducao}};

% \node [anchor=west,shift={(.7cm,-.75cm)}, text width=4cm, align=center] at (current bounding box.north west) {Miguel, qual fração é maior, $\frac{1}{3}$ ou $\frac{8}{25}$?};
% \node [anchor=west,shift={(1.3cm,-2.15cm)}, text width=4.75cm, align=center, font=\tiny, scale=.93] at (current bounding box.north west) {Hummm... Os denominadores são diferentes... Os numeradores também são diferentes...};

% \node [anchor=west,shift={(8.5cm,-.75cm)}, text width=3.75cm, align=center, font=\tiny,scale=.875] at (current bounding box.north west) {Parece difícil comparar. Você tem alguma figura?};
% \end{tikzpicture}

\includegraphics[width=.98\linewidth]{licao04/quadrinho-introducao}
\end{figure}
...
\begin{atividade}{}\label{chap4-ativ1}
...
\begin{center}
  \includegraphics[width=.40\textwidth, keepaspectratio]{licao04/dobradura-geogebra-10x1.png}\quad \includegraphics[width=.40\textwidth, keepaspectratio]{licao04/dobradura-geogebra-10x2.png}
\end{center}
...
\includegraphics[width=.40\textwidth, keepaspectratio]{licao04/dobradura-geogebra-10x4.png}
\end{figure}
...
\begin{atividade}{}\label{chap4-ativ3}
...
\begin{atividade}{}\label{chap4-ativ4}
...
\begin{center}
\includegraphics[width=.45\linewidth, keepaspectratio]{licao04/ativ4_fig01.png}
\end{center}

\begin{wrapfigure}[5]{r}{.22\linewidth}
\vspace{-1em}
\includegraphics[width=\linewidth, keepaspectratio]{licao04/ativ4_fig02.png}
\end{wrapfigure}
...
\begin{center}
\begin{tikzpicture}[scale=.8]
  \draw[fill=cbpurple] (20,0) arc (0:60:20) -- (0,0)--cycle;
\end{tikzpicture}
\end{center}
     &  &  &  \\
    \hline
...
\centering
 ...
 \begin{longtable}{|e{.4\textwidth}|e{.25\textwidth}|e{.25\textwidth}|}
    \hline
...
\fit{\begin{tikzpicture}
   ...
   \draw (30,0) -- (30,12);
       \end{tikzpicture}}   &   $2$& \fit{$\dfrac{1}{2}$} \\
    \hline
 \fit{\begin{tikzpicture}
...
O objetivo desta parte é explorar a fração do retângulo logo a seguir que está pintada no segundo encarte que você recebeu.
\begin{center}
...
\noindent  \begin{longtable}{|e{.32\linewidth}|e{.18\linewidth}|e{.16\linewidth}|e{.2\linewidth}|}
 \hline
 \centering {\small Peça} &   {\small Quantas peças como essa são necessárias para juntas cobrirem a região cinza?} & {\small  Que fração do retângulo é a região pintada? Complete. }  & {\small Que fração do retângulo do encarte não está colorida de cinza?} \\
    \hline 
     \endhead
\fit{\begin{tikzpicture}[x=1mm, y=1mm]
% Fita de largura 1/2
\draw[fill=cborange] (0,0) rectangle (100/2,10);
\end{tikzpicture}} &  \parbox[t][1.3 cm][c]{.2cm}{ } &  \fit{$\dfrac{\phantom{0}\square\phantom{0}}{2}$} &  \\
    \hline
\fit{\begin{tikzpicture}[x=1mm, y=1mm]
% Fita rosa de largura 1/4
\draw[fill=cbpink] (0,0) rectangle (100/4,10);
\end{tikzpicture}}
        &  \parbox[t][1.3 cm][c]{.2cm}{ } &   \fit{$\dfrac{\phantom{0}\square\phantom{0}}{4}$}  &  \\
    \hline
 \fit{\begin{tikzpicture}[x=1mm, y=1mm]
% Fita rosa de largura 1/6
\draw[fill=cbred] (0,0) rectangle (100/6,10);
\end{tikzpicture}}    &  \parbox[t][1.3 cm][c]{.2cm}{ } &  \fit{$\dfrac{\phantom{0}\square\phantom{0}}{6}$} &  \\
    \hline
\fit{\begin{tikzpicture}[x=1mm, y=1mm]
% Fita rosa de largura 1/8
\draw[fill=stred] (0,0) rectangle (100/8,10);
\end{tikzpicture}}     &  \parbox[t][1.3 cm][c]{.2cm}{ } &  \fit{$\dfrac{\phantom{0}\square\phantom{0}}{8}$} &  \\
    \hline
\fit{\begin{tikzpicture}[x=1mm, y=1mm]
% Fita rosa de largura 1/10
\draw[fill=common] (0,0) rectangle (100/10,10);
\end{tikzpicture}}     &  \parbox[t][1.3 cm][c]{.2cm}{ } &  \fit{$\dfrac{\phantom{0}\square\phantom{0}}{10}$} &  \\
    \hline
\fit{\begin{tikzpicture}[x=1mm, y=1mm]
% Fita rosa de largura 1/16
\draw[pattern=north west lines, pattern color=cbblue] (0,0) rectangle (100/16,10);
\end{tikzpicture}}     &  \parbox[t][1.3 cm][c]{.2cm}{ } &  \fit{$\dfrac{\phantom{0}\square\phantom{0}}{16}$} &  \\
    \hline
  \end{longtable}
\end{atividade}
\clearpage
...
\begin{enumerate}  %d
  \item     Preencha os quadradinhos     $\square$ com numeradores adequados de modo que cada fração corresponda sua respectiva marca em cada reta numérica.    
...
\begin{atividade}{}\label{chap4-ativ8}
...
\begin{atividade}{}\label{chap4-ativ11}
...
\begin{atividade}{}\label{chap4-ativ13}
...
\begin{atividade}{}\label{chap4-ativ15}
...
\begin{atividade}{}\label{chap4-ativ16}
...
\includegraphics[width=.85\linewidth]{licao04/ativ20-fig01}
\end{figure}
...
\begin{center}
\includegraphics[width=70pt, keepaspectratio]{licao04/ativ20-fig02}
\end{center}
...
\begin{atividade}{}\label{chap4-ativ23}
