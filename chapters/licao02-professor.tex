...
\begin{center}
 ...
 \node[rotate=90, stred] at (15,54) {{\small Amarildo}};
 \node[rotate=90, stred] at (15,42) {{\small Beto}};
 \node[rotate=90, stred] at (15,30) {{\small Carlos}};
 \node[rotate=90, stred] at (15,18) {{\small Davi}};
 \node[rotate=90, stred] at (15,6) {{\small Edison}};
...
\begin{center}
 ...
 \foreach \x in {12,24,...,48} \draw (0,\x) -- (30,\x);
 \node[rotate=90, stred] at (15,54) {{\small Amarildo}};
 \node[rotate=90, stred] at (15,42) {{\small Amarildo}};
 \node[rotate=90, stred] at (15,30) {{\small Amarildo}};
 \node[rotate=90, stred] at (15,18) {{\small Beto}};
 \node[rotate=90, stred] at (15,6) {{\small Beto}};
\end{tikzpicture}\hspace{1em}
\begin{tikzpicture}[yscale=.45,xscale=.4, x=1mm,y=1mm, rotate=90]
 \draw (0,0) rectangle (30,60);
 \foreach \x in {12,24,...,48} \draw (0,\x) -- (30,\x);
 \node[rotate=90, stred] at (15,54) {{\small Beto}};
 \node[rotate=90, stred] at (15,42) {{\small Carlos}};
 \node[rotate=90, stred] at (15,30) {{\small Carlos}};
 \node[rotate=90, stred] at (15,18) {{\small Carlos}};
 \node[rotate=90, stred] at (15,6) {{\small Davi}};
 \node[rotate=90, stred] at (15,6) {{\small\phantom{Amarildo}}};
\end{tikzpicture}\hspace{1em}
\begin{tikzpicture}[yscale=.45,xscale=.4, x=1mm,y=1mm, rotate=90]
 \draw (0,0) rectangle (30,60);
 \foreach \x in {12,24,...,48} \draw (0,\x) -- (30,\x);
 \node[rotate=90, stred] at (15,54) {{\small Davi}};
 \node[rotate=90, stred] at (15,42) {{\small Davi}};
 \node[rotate=90, stred] at (15,30) {{\small Edison}};
 \node[rotate=90, stred] at (15,18) {{\small Edison}};
 \node[rotate=90, stred] at (15,6) {{\small Edison}};
  \node[rotate=90, stred] at (15,6) {{\small\phantom{Amarildo}}};
...
\begin{enumerate} %s
  ...
  \begin{center}
  \includegraphics[width=100pt, keepaspectratio]{licao02/ativ3_resposta.png}
  \end{center}
...
\solucao
\begin{center}
    \begin{tabular}{e{.20\linewidth}e{.20\linewidth}e{.20\linewidth}e{.20\linewidth}}
      ...
      \hline
       \centering $\dfrac{4}{12}$& \centering  $\dfrac{5}{12}$& \centering  $\dfrac{2}{12}$ & \centering  $\dfrac{1}{12}$
    \end{tabular}
\end{center}
\begin{enumerate} %s
...
\newcommand\fit[1]{\parbox[c][2cm]{\linewidth}{\centering#1}}
    ...
    {
    \begin{tabular}{|>{\large}e{0.15\linewidth}|>{\large}e{0.3\textwidth}|>{\large}e{0.2\linewidth}|}
    \hline
          \centering A pintar  & \centering Figura & Sem ser pintada  \\
          \hline
     \centering $\dfrac{5}{6}$& \fit{
    ...
    &  $$\dfrac{1}{6}$$ \\
        \hline
         \centering $\dfrac{3}{4}$&  \fit{ \begin{tikzpicture}[x=1mm,y=1mm]
        ...
        \hline
         \centering $\dfrac{2}{5}$&   \fit{
                                      ...
                                      \end{tikzpicture} \hspace{.5ex}ou\hspace{.5ex}
                                    \begin{tikzpicture}[x=1mm,y=1mm,scale=.8]
                                        \draw[fill=common, fill opacity=.3] (0,0) rectangle (25,16);
                                       ...
                                       & $$\dfrac{3}{5}$$ \\
        \hline
         \centering $\dfrac{2}{3}$&  \fit{ \begin{tikzpicture}[x=1mm,y=1mm]
                                    ...
                                    \begin{tikzpicture}[x=1mm,y=1mm]
                                      \foreach \x in {120,180,240} \fill[attention] (\x:8)--(\x+60:8)--(0,0)--cycle;
                                       ...
                                       & $$\dfrac{1}{3}$$ \\
        \hline
         \centering $\dfrac{3}{8}$&   \fit{ \begin{tikzpicture}[x=1mm,y=1mm]
                                        \draw[fill=common, fill opacity=.3] (0,0) circle (8);
        ...
        \hline
         \centering $\dfrac{9}{10}$& \fit{ \begin{tikzpicture}[x=1mm,y=1mm,scale=.8]
...
\node (1) [circ, right of=larg, label=below:Matheus] {} node [above of=1, node distance=.5cm]{\includegraphics[width=1cm]{licao02/carrinho1.png}};

\node (2) [circ, right of=1, label=below:Lucas] {} node [above of=2, node distance=.5cm]{\includegraphics[width=1cm]{licao02/carrinho2.png}};
...
\node (3) [circ, right of=2, label=below:Heitor] {} node [above of=3, node distance=.5cm] {\includegraphics[width=1cm]{licao02/carrinho3.png}};
...
% \node (7) [circ, right of=6, label=below:Guilherme] {} node [above of=7, node distance=.5cm] {\includegraphics[width=1cm]{licao02/carrinho2.png}};
...
\node (4) [circ, right of=3, label=below:Rafael] {} node [above of=4, node distance=.5cm] {\includegraphics[width=1cm]{licao02/carrinho4.png}};

\node (5) [circ, right of=4, label=below:{Enzo}] {} node [above of=5, node distance=.5cm] {\includegraphics[width=1cm]{licao02/carrinho5.png}};

\node (6) [circ, right of=5, label=below:{Nicolas}] {} node [above of=6, node distance=.5cm] {\includegraphics[width=1cm]{licao02/carrinho6.png}};
...
\node (3) [circ, right of=2, label={[below of=4, align=center, node distance=.7cm] Heitor e\\Lorenzo}] {} node [above of=3, node distance=.5cm] {\includegraphics[width=1cm]{licao02/carrinho3.png}};
...
\node (4) [circ, right of=3, label={[below of=4, align=center, node distance=.7cm] Rafael e\\ Guilherme}] {} node [above of=4, node distance=.5cm] {\includegraphics[width=1cm]{licao02/carrinho4.png}};
...
\node (4) [circ, right of=3, label={[below of=4, align=center, node distance=.925cm] Rafael,\\Samuel e\\ Guilherme}] {} node [above of=4, node distance=.5cm] {\includegraphics[width=1cm]{licao02/carrinho4.png}};
...
\begin{enumerate} %s
    ...
    \begin{tikzpicture}[x=.5mm,y=.5mm]
     \draw[fill=common, fill opacity=.3] (0:4) -- (60:4)--(120:4)-- (180:4)--(240:4)--(300:4)--cycle;
    \end{tikzpicture}
 então a região pintada de vermelho em  \begin{tikzpicture}[x=.5mm,y=.5mm]
...
\end{scope}
\end{tikzpicture}
é   $\frac{1}{2}$ dessa unidade. Por outro lado,  se a unidade for   \begin{tikzpicture}[x=.5mm,y=.5mm]
                                                                        \draw[fill=common, fill opacity=.3] \tripinha;
                                                                       \end{tikzpicture}
   então a região pintada de vermelho em  \begin{tikzpicture}[x=.5mm,y=.5mm]
 \draw[fill=common, fill opacity=.3] \tripinha;
...
\end{tikzpicture}
   é   $\frac{1}{2}$ dessa unidade. Por outro lado,  se a unidade for  \begin{tikzpicture}[x=.5mm,y=.5mm]
    ...
    \item       A região em vermelho pode representar       $\frac{3}{5}$ ou       $3$ dependendo da unidade, que não foi explicitada no enunciado. Se, por exemplo, a unidade for \begin{tikzpicture}[x=.5mm,y=.5mm] \draw[fill=common, fill opacity=.3] \tripalonga  \end{tikzpicture} então a região pintada de vermelho em \begin{tikzpicture}[x=.5mm,y=.5mm]
...
\end{scope}
\end{tikzpicture}
  é   $\frac{3}{5}$ dessa unidade. Por outro lado,  se a unidade for \begin{tikzpicture}[x=.5mm,y=.5mm]
     \draw[fill=common, fill opacity=.3] (0:4) -- (60:4)--(120:4)-- (180:4)--(240:4)--(300:4)--cycle;
    \end{tikzpicture} então a região pintada de vermelho em \begin{tikzpicture}[x=.5mm,y=.5mm]
 \draw[fill=common, fill opacity=.3] \tripalonga;
\begin{scope}
 \clip \tripalonga;
  \draw[fill=attention] (-4,-4) rectangle ({10*sqrt(3)},4);
...
\begin{atividade}\label{chap2-ativ20}
\objetivos
\begin{itemize} %s
